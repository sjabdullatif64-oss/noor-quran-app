...
**How to apply:** Keep the classifier conservative and deterministic. Accept Quran/Islamic terms plus clearly direct theological questions such as who created the world or the heavens and earth. Keep simple Islamic answers eligible without requiring a Quran keyword, and leave verified-reference selection downstream of the scope decision.